# databricks_bundles_cicd_training

The 'databricks_bundles_cicd_training' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/databricks_bundles_cicd_training/`: Shared Python code that can be used by jobs and pipelines.
